...
export const metadata: Metadata = {
  title: "GrandView Hotel - Luxury Accommodation & Exceptional Service",
  description: "Experience luxury redefined at GrandView Hotel. Premium suites, fine dining, and world-class amenities in the heart of the city.",
  keywords: "luxury hotel, premium accommodation, five star hotel, city hotel, business travel, vacation hotel",
  metadataBase: new URL("https://grandviewhotel.com"),
  alternates: {
    canonical: "https://grandviewhotel.com"
  },
  openGraph: {
    title: "GrandView Hotel - Luxury Accommodation & Exceptional Service",
    description: "Experience luxury redefined at GrandView Hotel. Premium suites, fine dining, and world-class amenities in the heart of the city.",
    siteName: "GrandView Hotel",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/15447099/pexels-photo-15447099.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "GrandView Hotel - Luxury Accommodation & Exceptional Service",
    description: "Experience luxury redefined at GrandView Hotel. Premium suites, fine dining, and world-class amenities in the heart of the city.",
    images: ["https://images.pexels.com/photos/15447099/pexels-photo-15447099.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
